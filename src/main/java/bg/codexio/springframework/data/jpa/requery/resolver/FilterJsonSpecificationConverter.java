...
public class FilterJsonSpecificationConverter {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final FilterJsonTypeConverter converter;

    public FilterJsonSpecificationConverter(FilterJsonTypeConverter converter) {
     ...
     */
    public Specification<Object> noFilterSpecification() {
     ...
     *                                 string.
     */
    public Specification<Object> getComplexFilterSpecification(
     ...
     * provided.
     */
    public Specification<Object> getSimpleFilterSpecification(
